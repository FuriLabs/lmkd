 ...
 */
static inline void lmkd_pack_get_target(LMKD_CTRL_PACKET packet, int target_idx, struct lmk_target *target) {
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
static inline size_t lmkd_pack_set_target(LMKD_CTRL_PACKET packet, struct lmk_target *targets, size_t target_cnt) {
    int idx = 0;
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
static inline void lmkd_pack_get_procprio(LMKD_CTRL_PACKET packet, int field_count, struct lmk_procprio *params) {
